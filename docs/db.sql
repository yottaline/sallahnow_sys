...
DROP TABLE IF EXISTS `market_product_photos`;
DROP TABLE IF EXISTS `market_product_views`;
DROP TABLE IF EXISTS `market_products`;
DROP TABLE IF EXISTS `market_retailers`;
DROP TABLE IF EXISTS `market_stores`;
DROP TABLE IF EXISTS `market_subcategories`;
...
CREATE TABLE IF NOT EXISTS `market_retailers` (
  ...
  FOREIGN KEY (`retailer_store`) REFERENCES `market_stores`(`store_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `market_subcategories` (
  ...
  `subcategory_cat` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `market_products` (
  ...
  `product_disc` DECIMAL(9, 2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `market_product_photos` (
  ...
  `photo_product` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `market_product_views` (
  ...
  `view_product` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS  `market_order_items` (
  ...
  FOREIGN KEY (`orderItem_order`) REFERENCES `market_orders`(`order_id`),
  FOREIGN KEY (`orderItem_product`) REFERENCES `market_products`(`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
