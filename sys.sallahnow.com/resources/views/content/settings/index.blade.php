                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form action="{{ route('location_store') }}" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="locationNameEn">Name EN<b class="text-danger">&ast;</b></label>
                                    <input type="text" name="location_name_en" id="locationNameEn"
                                        class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="locationNameAr">Name AR<b class="text-danger">&ast;</b></label>
                                    <input type="text" name="location_name_ar" id="locationNameAr"
                                        class="form-control" required>
                                </div>
                                <div class="d-flex">
                                    <button type="button" class="btn btn-outline-secondary btn-sm me-auto"
                                ...
                                <form method="POST" action="/models/submit/" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1">Logo<b
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="brand" class="form-control">
                                            ...
                                            <option data-ng-repeat="brand in brands track by $index"
                                                data-ng-value="brand.id" data-ng-bind="brand.name">
                                            </option>
